...
class Cadastro():
    def __init__ (self):
        ...
        self.Btn_Salvar = Button(self.CadastroCanvas,text="SALVAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Salvar)
        self.CadastroCanvas.create_window(1000,420,window=self.Btn_Salvar)
        self.Btn_Limpar = Button(self.CadastroCanvas,text="LIMPAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Limpar)
        self.CadastroCanvas.create_window(1000,470,window=self.Btn_Limpar)
        self.Btn_Voltar = Button(self.CadastroCanvas,text="VOLTAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Voltar)
