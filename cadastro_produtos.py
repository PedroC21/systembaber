...
class Cadastro_Produtos():
    def __init__ (self):
        ...
        self.btn_salvar = Button(self.ProdutoCanvas,text="SALVAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#000000",width=10,command=Salvar)
        self.ProdutoCanvas.create_window(450,500,window=self.btn_salvar)
        self.btn_limpar = Button(self.ProdutoCanvas,text="LIMPAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#000000",width=10,command=Limpar)
        self.ProdutoCanvas.create_window(600,500,window=self.btn_limpar)
        self.btn_voltar = Button(self.ProdutoCanvas,text="VOLTAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#000000",width=10,command=Voltar)
