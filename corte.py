...
class Corte ():
    def __init__(self):
        ...
        self.CorteCanvas.create_rectangle(590,320,850,450,outline="white")
        ...
        self.Btn_Selecionar = Button(self.CorteCanvas,text="SELECIONAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Selecionar)
        ...
        self.Btn_Adicionar= Button(self.CorteCanvas,text="+",width=1,bg="black",fg="white",activebackground="#f2f7f7",command=Adicionar)
        ...
        def Confirmar():
            ...
            Corte()
        self.Btn_Confirmar= Button(self.CorteCanvas,text="CONFIRMAR",width=10,bg="black",fg="white",activebackground="white",command=Confirmar)
        ...
        self.Btn_Voltar= Button(self.CorteCanvas,text="VOLTAR",width=10,bg="black",fg="white",activebackground="white",command=Voltar)
