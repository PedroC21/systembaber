...
class Login():
    def __init__ (self):
        ...
        #BACKGROUND
        self.LoginBack = PhotoImage(file="image/lgb.png")
        ...
        def Cadastrar():
            ...
            self.btn_confirmar = Button(self.cadastrar_canvas,text='CONFIRMAR',width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Aceitar)
            self.cadastrar_canvas.create_window(200,200,window=self.btn_confirmar)
            def Voltar():
                self.cadastrar_canvas.destroy()
                
            self.btn_back = Button(self.cadastrar_canvas,text='VOLTAR',width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Voltar)
        ...
        self.LoginUser = Entry(self.LoginCanvas,width=20,highlightcolor="black")
        ...
        self.SenhaUser = Entry(self.LoginCanvas,width=20,highlightcolor="black",show="*")
        self.LoginCanvas.create_window(600,380,window=self.SenhaUser)
        self.ButtonAccept = Button(self.LoginCanvas,text="FAZER LOGIN",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=LoginConfirm)
        self.LoginCanvas.create_window(600,430,window=self.ButtonAccept)
        self.ButtonCadastrar = Button(self.LoginCanvas,text='CADASTRAR',width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Cadastrar)
        self.LoginCanvas.create_window(600,470,window=self.ButtonCadastrar)
        #ERRO DE LOGIN
        self.LogError = self.LoginCanvas.create_text(600,530,text="",font=("Arial",12,"bold"),fill="white")
        
        #CREDITOS
        self.LoginCanvas.create_text(600,580,text="Sistema desenvolvido para Disciplina Extensiva",font=("Arial",8,"bold"),fill="white")
