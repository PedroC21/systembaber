...
class Menu():
    def __init__ (self):
        ...
        self.MenuBackground = PhotoImage(file="image/mn.png")
        ...
        if str(self.login_active[0]) == "sim":
            def Clientes():
                ...
                self.Btn_Cadastrar = Button(self.MenuCanvas,text="CADASTRAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#f2f7f7",width=10,command=Cadastro)
                ...
                self.Btn_Consultar = Button(self.MenuCanvas,text="CONSULTAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#f2f7f7",width=10,command=Search)
                ...
                self.Btn_Close = Button(self.MenuCanvas,text="FECHAR",font=("Arial Black",10,"bold"),fg="black",bg="white",activebackground="#f2f7f7",width=10,command=Close)
                self.ClientesCanvas.create_window(100,150,window=self.Btn_Close)
                
            self.Btn_Img1 = PhotoImage(file="image/clientes.png")    
            self.Btn_Clientes = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img1,text="CLIENTES",font=("Arial Black",20,"bold"),fg="black",bg="white",activebackground="#f2f7f7",command=Clientes)
            ...
            self.Btn_Cortar = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img2,text="CORTAR",font=("Arial Black",20,"bold"),fg="black",bg="white",activebackground="#f2f7f7",command=Cortar)
            ...
            def Produtos():
                ...
                self.Btn_Prod_Cad = Button(self.ProdutosCanvas,text="CADASTRAR",font=("Arial Black",10,"bold"),fg="white",bg="black",activebackground="#f2f7f7",width=10,command=CadastrarProdutos)
                ...
                self.Btn_Prod_Cons = Button(self.ProdutosCanvas,text="ESTOQUE",font=("Arial Black",10,"bold"),fg="white",bg="black",activebackground="#f2f7f7",width=10,command=Estoque)
                ...
                self.Btn_Prod_Close = Button(self.ProdutosCanvas,text="FECHAR",font=("Arial Black",10,"bold"),fg="white",bg="black",activebackground="#f2f7f7",width=10,command=CloseProdutos)
                self.ProdutosCanvas.create_window(100,150,window=self.Btn_Prod_Close)
                
            
            self.Btn_Img3 = PhotoImage(file="image/produtos.png")
            self.Btn_Produtos = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img3,text="PRODUTOS",font=("Arial Black",20,"bold"),fg="black",activebackground="#f2f7f7",command=Produtos)
            ...
            self.Btn_Caixa = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img4,text="CAIXA",font=("Arial Black",20,"bold"),fg="black",bg="white",activebackground="#f2f7f7",command=Caixa)
            ...
            self.Btn_Relatorio = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img5,text="RELATÓRIO",font=("Arial Black",20,"bold"),fg="black",bg="white",activebackground="#f2f7f7",command=Relatorio)
            ...
            self.Btn_Deslogar = Button(self.MenuCanvas,compound = BOTTOM,image=self.Btn_Img6,text="DESLOGAR",font=("Arial Black",20,"bold"),fg="black",bg="white",activebackground="#f2f7f7",command=Logout)
