...
class Search():
    def __init__ (self):
        ...
        self.Button_Search = Button(self.LocalizarCanvas,text="BUSCAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=ClienteBusca)
        ...
        def Editar():
            ...
            self.ButtonSave = Button(self.LocalizarCanvas,text="SALVAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Salvar)
        ...
        self.ButtonEdit = Button(self.LocalizarCanvas,text="EDITAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Editar)
        self.LocalizarCanvas.create_window(450,550,window=self.ButtonEdit)
        self.ButtonDelete = Button(self.LocalizarCanvas,text="DELETAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Deletar)
        self.LocalizarCanvas.create_window(600,550,window=self.ButtonDelete)
        self.ButtonVoltar = Button(self.LocalizarCanvas,text="VOLTAR",width=10,bg="black",fg="white",activebackground="#f2f7f7",command=Voltar)
