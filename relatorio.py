    ...
    def __init__(self):
        ...
        def Selecionar():
            ...
            if self.filtro.get() == "POR DATA":
                ...
                self.btn_confirmar = Button(self.relatorio_canvas,text="CONFIRMAR",width=10,bg="black",fg="white",activebackground="white",command=Confirmar)
                self.relatorio_canvas.create_window(600,300,window=self.btn_confirmar)
                
        self.btn_selecionar = Button(self.relatorio_canvas,text="SELECIONAR",width=10,bg="black",fg="white",activebackground="white",command=Selecionar)
        self.relatorio_canvas.create_window(750,200,window=self.btn_selecionar)
        
        def Limpar():
            self.relatorio_geral.delete(1.0, END)
        self.btn_limpar = Button(self.relatorio_canvas,text="LIMPAR",width=10,bg="black",fg="white",activebackground="white",command=Limpar)
        self.relatorio_canvas.create_window(880,200,window=self.btn_limpar)
        
        def Voltar():
            self.relatorio_janela.destroy()
            menupy.Menu.__init__(self)
        self.btn_voltar = Button(self.relatorio_canvas,text="VOLTAR",width=10,bg="black",fg="white",activebackground="white",command=Voltar)
